...
OWNER_ID = 7142950609  # apna Telegram numeric ID yaha daal
...
def admin_keyboard():
    ...
    kb.add(types.InlineKeyboardButton("🔘 Button Broadcast", callback_data="admin_button_broadcast"))
...
def cb_button_broadcast(call):
    ...
    bot.send_message(
        call.message.chat.id,
        "🔘 Send format:\n\n<code>Message | Button Name | https://link.com</code>"
)
  # =====================
# SEND HELPERS
# =====================
